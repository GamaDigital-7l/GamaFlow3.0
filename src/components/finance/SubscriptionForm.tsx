    ...
    <form onSubmit={handleSubmit} className="grid gap-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="grid gap-2">
          ...
          <Select value={frequency} onValueChange={(value) => setFrequency(value as RecurrenceFrequency)} disabled={isSubmitting}>
            <SelectTrigger>
      ...
      <div className="grid gap-2">
        ...
        <Select value={category} onValueChange={setCategory} disabled={isSubmitting}>
          ...
          <SelectContent>
            {/* Usando um valor não-vazio para 'Nenhuma' */}
            <SelectItem value="N/A_CATEGORY">Nenhuma</SelectItem> 
