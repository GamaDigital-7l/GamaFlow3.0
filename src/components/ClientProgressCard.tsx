...
export const ClientProgressCard: React.FC<ClientProgressCardProps> = ({ client, isClickable = true }) => {
  ...
  const MinimalProgressContent = (
    <div className="space-y-1">
        ...
        <Progress value={client.percentage} className="h-1.5" indicatorClassName={getStatusColor()} />
    </div>
  );
  ...
  return (
      <>
        ...
        >
          <CardHeader className="p-0 pb-2 flex flex-row items-center justify-between border-b border-border/50">
          ...
          <CardContent className="p-0 space-y-3">
            ...
            <Progress value={client.percentage} className="h-2" indicatorClassName={getStatusColor()} />
