...
const STATUS_OPTIONS: LeadStatus[] = ['Prospectando', 'Contato Feito', 'Reunião Agendada', 'Proposta Enviada'];
const ORIGIN_OPTIONS: LeadOrigin[] = ['Indicação', 'Tráfego Pago', 'Orgânico', 'Outro'];
    ...
    <form onSubmit={handleSubmit} className="grid gap-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="grid gap-2">
          ...
          <Select value={status} onValueChange={(value) => setStatus(value as LeadStatus)} disabled={isSubmitting || !!initialData}>
            <SelectTrigger>
        ...
        <div className="grid gap-2">
          ...
          <Select value={origin} onValueChange={(value) => setOrigin(value as LeadOrigin)} disabled={isSubmitting}>
            <SelectTrigger>
