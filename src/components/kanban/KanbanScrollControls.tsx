  ...
  return (
    <div className="absolute inset-y-0 left-0 right-0 flex items-center justify-between pointer-events-none">
      ...
      <Button
        ...
        size="icon"
        className={cn(
          "z-10 h-10 w-10 rounded-full bg-card/80 hover:bg-card pointer-events-auto shadow-lg ml-2",
      ...
      <Button
        ...
        size="icon"
        className={cn(
          "z-10 h-10 w-10 rounded-full bg-card/80 hover:bg-card pointer-events-auto shadow-lg mr-2",
          "opacity-70 hover:opacity-100 transition-opacity"
        )}
