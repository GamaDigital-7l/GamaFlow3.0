  ...
  return (
    <div className="space-y-6">
      ...
      <Card className={cn(
        ...
        <CardTitle className="text-xl mb-4">Resumo de {format(targetDate, 'MMMM/yyyy', { locale: ptBR })}</CardTitle>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader><CardTitle>Ganhos vs. Gastos</CardTitle></CardHeader>
          <CardContent>
