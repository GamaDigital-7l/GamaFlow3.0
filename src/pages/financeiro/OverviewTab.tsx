...
import { DollarSign, TrendingUp, TrendingDown, Wallet, Clock, Loader2, Plus, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0">
        ...
        <div className="flex space-x-2 w-full md:w-auto">
            ...
            <Button 
                ...
                className="bg-dyad-500 hover:bg-dyad-600 flex-shrink-0"
                disabled={isMutating}
            >
