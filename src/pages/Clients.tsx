...
const ClientsList: React.FC = () => {
  const { clients, addClient, updateClient, deleteClient, isMutating, isLoading } = useClientStore();
    ...
    <div className="p-4 space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button 
          ...
          disabled={isMutating}
        >
          {isMutating ? <Loader2 className="h-4 w-4 mr-2 animate-spin" /> : <Plus className="h-4 w-4 mr-2" />} Novo Cliente
        </Button>
      </div>
