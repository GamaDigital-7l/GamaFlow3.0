...
const ContractsPage: React.FC<ContractsPageProps> = ({ clientId }) => {
    const SECTION_NAME = 'contracts';
    ...
    return (
        <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
                Acesse os contratos e documentos legais do cliente.
            </p>

            <Card>
                <CardHeader>
                    <CardTitle>Arquivos de Contrato</CardTitle>
                </CardHeader>
                <CardContent>
                    {hasContent ? (
                        ...
                        <div className="text-center py-8 px-4 border-2 border-dashed rounded-lg">
                            <p className="text-muted-foreground">
                                Nenhum arquivo de contrato foi adicionado ainda.
                            </p>
                        </div>
                    )}
                </CardContent>
