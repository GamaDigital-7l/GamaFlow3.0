...
export function useNotesStore() {
    ...
    const noteMutation = useMutation({
        mutationFn: async (action: { type: 'add' | 'update' | 'delete', payload: any }) => {
            if (action.type === 'add') {
                ...
                const newNoteData = action.payload as Omit<Note, 'id' | 'createdAt' | 'updatedAt' | 'userId'>;
    ...
    const addNote = (newNoteData: Omit<Note, 'id' | 'createdAt' | 'updatedAt' | 'userId'> & { id: string }) => {
