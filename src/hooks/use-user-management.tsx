...
const LIST_USERS_FUNCTION_URL = 'https://cxntiszohzgntyhbagga.supabase.co/functions/v1/list-users';
// URL da Edge Function para criar usuários
const CREATE_USER_FUNCTION_URL = 'https://cxntiszohzgntyhbagga.supabase.co/functions/v1/create-client-user';
// URL da Edge Function para deletar usuários
const DELETE_USER_FUNCTION_URL = 'https://cxntiszohzgntyhbagga.supabase.co/functions/v1/delete-client-user';
...
const fetchAllUserProfiles = async (): Promise<UserProfile[]> => {
  ...
  return result.filter((user: UserProfile) => user.email !== 'supabase_admin');
};
...
const updateUserInDB = async (data: { id: string, email: string, role: string, client_id: string | null, password?: string }): Promise<void> => {
    ...
    const UPDATE_USER_FUNCTION_URL = 'https://cxntiszohzgntyhbagga.supabase.co/functions/v1/update-client-user';
